<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminEmpList.aspx.cs" Inherits="AdminEmpList" %>
...
<body bgcolor="#ccffcc" background="Images/bg.jpg">
    ...
    <div>
            ...
            Font-Size="Small" PostBackUrl="~/AdminMainPage.aspx" Style="z-index: 101; left: 2px;
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
            ...
            <Columns>
                <asp:BoundField DataField="uName" HeaderText="EmpCode" SortExpression="uName" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CnConnectionString %>"
            SelectCommand="SELECT [uName], [eName], [MobileNo], [eMail], [Gender], [Designation] FROM [EmpDetTab] ORDER BY [uName]">
              </asp:SqlDataSource>
        &nbsp; &nbsp; &nbsp;&nbsp;
        <asp:HyperLink ID="HyperLink1" runat="server" BackColor="Purple" Font-Bold="False"
            ...
            left: 121px; position: absolute; top: 200px" Width="576px">&nbsp; Employee  List</asp:HyperLink>
