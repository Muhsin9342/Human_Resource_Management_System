<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AJobDetails.aspx.cs" Inherits="AJobDetails" %>
...
<body bgcolor="#ccccff" background="Images/bg.jpg">
    ...
    <div>
        ...
        <asp:HyperLink ID="HyperLink3" runat="server" Font-Bold="False" Font-Names="Arial Black"
            ForeColor="#C04000" NavigateUrl="~/ClientMainPage.aspx" Style="z-index: 101; left: 0px;
        ...
        <asp:TextBox ID="TextBox2" runat="server" Style="z-index: 107; left: 415px; position: absolute;
            top: 253px" Width="231px" Height="14px"></asp:TextBox>
        &nbsp; &nbsp;
