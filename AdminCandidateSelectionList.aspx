<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminCandidateSelectionList.aspx.cs" Inherits="AdminCandidateSelectionList" %>
...
<body bgcolor="#ccccff" background="Images/bg.jpg">
    ...
    <div>
        ...
        <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource1"
            DataTextField="JobCode" DataValueField="JobCode" Style="z-index: 106; left: 291px;
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
            ...
            Style="z-index: 108; left: 177px; position: absolute; top: 293px" Width="826px" >
            <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
            <Columns>
                <asp:BoundField DataField="uName" HeaderText="uName" SortExpression="uName" />
                <asp:BoundField DataField="AppNo" HeaderText="AppNo" SortExpression="AppNo" />
                <asp:BoundField DataField="appDate" HeaderText="appDate" SortExpression="appDate" dataformatstring="{0:dd-MMM-yyyy}" HtmlEncode="False"/>
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:CnConnectionString %>"
            SelectCommand="SELECT [uName],[AppNo], [appDate], [AppName], [MobileNo], [eMail], [qualification], [experience] FROM [AppJobTab] WHERE ([JobCode] = @JobCode) and aStatus=1 order by appno desc">
            <SelectParameters>
