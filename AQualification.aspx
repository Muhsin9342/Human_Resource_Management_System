<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AQualification.aspx.cs" Inherits="AQualification" %>
...
<body bgcolor="#ccccff" background="Images/bg.jpg">
    ...
    <div>
        ...
        <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="False" Font-Names="Arial Black"
            Style="z-index: 103; left: 176px; position: absolute; top: 174px" BackColor="#0000C0" Font-Size="XX-Large" ForeColor="#8080FF" Width="555px">Qualification Details</asp:HyperLink>
        <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Names="Verdana" ForeColor="Teal"
            Style="z-index: 104; left: 179px; position: absolute; top: 245px" Text="Qualification  Name"></asp:Label>
        ...
        <asp:HyperLink ID="HyperLink17" runat="server" BackColor="#FFC0FF" Font-Bold="False"
            Font-Names="Arial Black" NavigateUrl="~/AQualificationList.aspx" Style="z-index: 113;
            left: 186px; position: absolute; top: 392px" Width="193px">Qualification List</asp:HyperLink>
    
    </div>
    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
        ControlToValidate="TextBox1" ErrorMessage="ENTER QULIFICATION NAME" 
        style="z-index: 1; left: 609px; top: 244px; position: absolute"></asp:RequiredFieldValidator>
    </form>
</body>
</html>
